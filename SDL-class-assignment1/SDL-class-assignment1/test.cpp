...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./Assets/skytoon.jpg"));
    backgroundTextures.push_back(loadTexture("./Assets/airplane.png"));
...
//    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/layer11.png"));
    ...
    // Define the desired width and height for the textures
    ...
    while (!quit) {
        ...
        for (SDL_Texture* texture : backgroundTextures) {
            ...
            // Calculate the new destination rectangle with the desired size
            SDL_Rect textureDest = { 0, 0, desiredWidth, desiredHeight };
