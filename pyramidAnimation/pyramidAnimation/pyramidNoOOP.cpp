...
Point3D scaleOut(Point3D point)
{
    ...
    float pulsation = sin(iterations * 0.05); // Adjust the frequency of pulsation by changing the multiplier
    float scaledFactor = 1 + pulsation * 0.2; // Adjust the amplitude of pulsation by changing the multiplier
